 ...
 * <ul>
 *   <li>{@link de.devboost.natspec.library.documentation.Line#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @see de.devboost.natspec.library.documentation.DocumentationPackage#getLine()
 ...
 * @generated
 */
public interface Line extends Fragment
{
  /**
   ...
   * <!-- end-user-doc -->
	 ...
	 * @see #setText(String)
	 * @see de.devboost.natspec.library.documentation.DocumentationPackage#getLine_Text()
	 * @model required="true"
  ...
  /**
	 * Sets the value of the '{@link de.devboost.natspec.library.documentation.Line#getText <em>Text</em>}' attribute.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
