...
public class OverbookSeatNumber {
	...
	public void executeScript() throws Exception {
		// The code in this method is generated from: /de.devboost.natspec.examples.airline.test/src-endusertests/de/devboost/natspec/examples/airline/test/OverbookSeatNumber.natspec
		...
		de.devboost.natspec.examples.airline.entity.Passenger passenger_Jane_Doe = testSupport.givenAPassenger("Jane", "Doe");
		// Book seat for Jane Doe at LH-1234
		de.devboost.natspec.examples.airline.services.OperationStatus operationStatus_Jane_Doe_LH_1234 = testSupport.bookSeat(passenger_Jane_Doe, flight_LH_1234);
		// Assume success
		testSupport.assumeSuccess(operationStatus_Jane_Doe_LH_1234);
		// Given a passenger Jim Doe
		de.devboost.natspec.examples.airline.entity.Passenger passenger_Jim_Doe = testSupport.givenAPassenger("Jim", "Doe");
		// Book seat for Jim Doe at LH-1234
		de.devboost.natspec.examples.airline.services.OperationStatus operationStatus_Jim_Doe_LH_1234 = testSupport.bookSeat(passenger_Jim_Doe, flight_LH_1234);
		// Assume failure
