...
public class BookSeatTwice extends NatSpecJUnit4Template {
	...
	public void runTest() throws Exception {
		...
		// Wenn John Doe erneut ein Ticket für LH-1234 bucht
		log("Wenn John Doe erneut ein Ticket für LH-1234 bucht");
		com.nat_spec.examples.airline.services.OperationStatus operationStatus_John_Doe_LH_1234 = testSupport.wennErneutEinTicketFürBucht(passenger_John_Doe, flight_LH_1234);
		// Wird kein valides Ticket ausgestellt
		log("Wird kein valides Ticket ausgestellt");
		testSupport.assumeFailure(operationStatus_John_Doe_LH_1234);
	...
	public static void createNatSpecDescription(INatSpecDefinitionHandler handler) {
		...
		handler.registerComment("/// Doppelbuchung nicht möglich");
		handler.register("Wenn John Doe erneut ein Ticket für LH-1234 bucht");
