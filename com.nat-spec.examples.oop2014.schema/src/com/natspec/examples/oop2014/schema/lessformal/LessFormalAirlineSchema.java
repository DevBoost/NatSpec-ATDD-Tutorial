...
public class LessFormalAirlineSchema extends AbstractNatSpecTemplate {
	...
	public void createDataModel() {
		...
		// The code in this method is generated from: /com.nat-spec.examples.oop2014.schema/src/com/natspec/examples/oop2014/schema/lessformal/LessFormalAirlineSchema.natspec
		// Never change this method or any contents of this file, all local changes will be overwritten.
		// Change _NatSpecTemplate.java instead.
		
		// An airplane is a transportation vehicle.
		com.natspec.examples.oop2014.schema.ddl.Table table_airplane_transportation_vehicle_ = lessFormalSchemaSupport.createTable("airplane", java.util.Arrays.asList(new java.lang.String[] {"transportation", "vehicle."}));
		...
		com.natspec.examples.oop2014.schema.ddl.Table table_passenger_person_who_uses_airline_services_ = lessFormalSchemaSupport.createTable("passenger", java.util.Arrays.asList(new java.lang.String[] {"person", "who", "uses", "airline", "services."}));
		...
		com.natspec.examples.oop2014.schema.ddl.Table table_flight_travel_service_provided_by_an_airline_ = lessFormalSchemaSupport.createTable("flight", java.util.Arrays.asList(new java.lang.String[] {"travel", "service", "provided", "by", "an", "airline."}));
